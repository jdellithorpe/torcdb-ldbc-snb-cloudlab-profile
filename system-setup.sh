...
apt-get update
apt-get --assume-yes install mosh vim tmux pdsh tree axel htop ctags cscope cmake clang gnuplot
# NFS
...
#mkdir $DATASETS_DIR; mount -t nfs4 $rcnfs_clan_ip:$RCNFS_DATASETS_EXPORT_DIR $DATASETS_DIR
